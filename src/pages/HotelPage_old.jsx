      ...
      <div className="glass-container">
        ...
        {selectedHotel && (
          <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            ...
            <div className="glass-card p-6 grid md:grid-cols-3 gap-6 items-center" key={index}>
              <div className="md:col-span-2 space-y-4">
                <h3 className="text-2xl font-bold text-white">{hotel.name}</h3>
                ...
                <div className="flex items-center justify-between">
                  <p className="text-2xl font-bold text-green-300">₹{hotel.price} / night</p>
                  <p className="text-white/80">{hotel.location}</p>
                </div>
                
                <div className="flex items-center justify-between">
                  <span className="glass-card px-4 py-2 text-sm text-white bg-blue-500/30">
                    {hotel.type}
                  </span>
